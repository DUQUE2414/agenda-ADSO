...
export default function FormularioContacto({ onAgregar }) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none mt-2"
      >
        Agregar contacto
      </button>
    </form>
